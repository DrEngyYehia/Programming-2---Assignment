...
###### I made a comment on the image because if the path is not working, there will be no error for the program
...
job_var.set("Programmer")
job_options = ["Programmer","Doctor","Acountant","Lawyer", "Engineer", "Teacher", "Other"]
...
calculate_button = tk.Button(bank, text="Calculate",padx=10,fg='white',background='limegreen',bd=3,pady=5 ,font=("Arial Bold",10), command=calculate_loan)
